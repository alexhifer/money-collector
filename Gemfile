...
gem 'sass-rails', '~> 5.0'
# Sass-powered version of Bootstrap 3 # https://github.com/twbs/bootstrap-sass
...
# and ORMs https://github.com/amatsuda/kaminari
gem 'kaminari'
...
group :development, :test do
  ...
  # Helper for faking web requests in Ruby
  gem 'fakeweb', '~> 1.3'
end
